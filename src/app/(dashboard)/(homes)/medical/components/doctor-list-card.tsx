                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center">
                                    <Image src={"/assets/images/home-eight/doctor-img1.png"} alt="" className="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden" />
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center">
                                    <Image src={"/assets/images/home-eight/doctor-img2.png"} alt="" className="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden" />
                                    <div className="flex-grow-1">
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center">
                                    <Image src={"/assets/images/home-eight/doctor-img3.png"} alt="" className="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden" />
                                    <div className="flex-grow-1">
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center">
                                    <Image src={"/assets/images/home-eight/doctor-img4.png"} alt="" className="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden" />
                                    <div className="flex-grow-1">
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center">
                                    <Image src={"/assets/images/home-eight/doctor-img6.png"} alt="" className="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden" />
                                    <div className="flex-grow-1">
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center">
                                    <Image src={"/assets/images/home-eight/doctor-img5.png"} alt="" className="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden" />
                                    <div className="flex-grow-1">
