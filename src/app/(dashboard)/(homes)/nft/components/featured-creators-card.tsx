                    ...
                    <div className="card-body px-6 py-5">
                        <div className="flex items-center justify-between gap-2 flex-wrap">
                            <div className="flex items-center">
                                <Image src={"/assets/images/nft/nft-items-img1.png"} alt="Image"
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div
                                    ...
                                    <div className="rounded overflow-hidden">
                                        <Image src={"/assets/images/nft/featured-creator1.png"} alt="Image"
                                            className="w-full h-full object-fit-cover" />
                                    </div>
                                    <div className="p-3">
                                        <h6 className="text-base font-bold text-[#0a0a0a] dark:text-white mb-3">New Figures</h6>
                                        <div className="flex items-center gap-2">
                                            <Image src={"/assets/images/nft/bitcoin.png"}
                                ...
                                <div
                                    className="nft-card bg-white dark:bg-slate-700 rounded overflow-hidden shadow-4">
                                    <div className="rounded overflow-hidden">
                                        <Image src={"/assets/images/nft/featured-creator2.png"} alt="Image"
                                            className="w-full h-full object-fit-cover" />
                                    </div>
                                    <div className="p-3">
