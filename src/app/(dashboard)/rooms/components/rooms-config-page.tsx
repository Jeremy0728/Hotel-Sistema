  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-3 justify-between">
          <div>
            <div className="mb-2 flex flex-wrap items-center gap-2">
              ...
              <span className="text-xs text-neutral-500 dark:text-neutral-300">
                Admin: parametrizacion y control de inventario
              </span>
            </div>
            <h2 className="text-lg font-semibold">Configuracion de habitaciones</h2>
          ...
          <div className="flex flex-wrap gap-2">
            <Button variant="outline" asChild>
              <Link href="/recepcion/habitaciones">Volver a recepcion</Link>
            </Button>
            <Button variant="outline" asChild>
      ...
      <Dialog open={Boolean(selectedRoom)} onOpenChange={() => setSelectedRoom(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Detalle de habitacion</DialogTitle>
          </DialogHeader>
          {selectedRoom ? (
      ...
      <Dialog open={formOpen} onOpenChange={setFormOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editingRoom ? "Editar habitacion" : "Nueva habitacion"}
            </DialogTitle>
          </DialogHeader>
          <RoomForm
            ...
            submitLabel={editingRoom ? "Guardar cambios" : "Crear habitacion"}
