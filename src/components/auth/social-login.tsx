    ...
    >
      ...
      >
        {loadingButtonProvider === "google" ? (
          ...
          <>
            <Image src="/assets/images/icons/google-icon.png" alt="google" width={18} height={18} />
            Google
          </>
        )}
      </Button>
      ...
      >
        {loadingButtonProvider === "github" ? (
          ...
          <>
            <Image src="/assets/images/icons/github-icon.png" alt="github" width={18} height={18} />
            Github
          </>
        )}
      </Button>
