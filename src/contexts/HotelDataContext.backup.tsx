...
export const HotelDataProvider = ({ children }: { children: ReactNode }) => {
  ...
  const useServiceBookings = () => {
    ...
    useEffect(() => {
      // Load service bookings from API or local storage
    }, []);

    return { serviceBookings, setServiceBookings, isLoadingServiceBookings };
  };
  ...
  const { serviceBookings, setServiceBookings, isLoadingServiceBookings } = useServiceBookings();
